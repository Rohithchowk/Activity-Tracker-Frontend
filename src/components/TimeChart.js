...
import { PieChart, Pie, Cell, Legend as RechartsLegend } from 'recharts'; // Import PieChart and related components
...
function upsert_data_to_server(data) {
    ...
    axios.put('http://localhost:9000/upsert', data)
        .then(response => {
        ...
        if (chartType === 'LineChart') {
            ...
            return (
                <PieChart width={400} height={400}>
                    ...
                    <Tooltip formatter={(value) => formatTooltip(value)} />
                    {/* <RechartsLegend layout="horizontal" verticalAlign="bottom" align="center" margin={{ right: 20 }} /> */}
                </PieChart>
            );
        }
    };
